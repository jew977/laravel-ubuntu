        ...
        <p><h3 class="text-center domain-title"></h3></p>
         <div class="row">
          <div class="col-xs-4 col-xs-offset-3">
              <form class="form-horizontal" method="POST" action="{{url('domain',$domains->id)}}">
                  <input name="_method" type="hidden" value="PATCH">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 <div class="form-group">
                     <label for="" class="col-sm-3">域名</label>
                     <div class="col-sm-9">
                         <input type="text" name="domain_name" value="{{$domains->domain_name}}" class="form-control">
                     </div>
                 </div>
                 <div class="form-group">
                     <label for="" class="col-sm-3">域名注册商</label>
                     <div class="col-sm-9">
                         <input type="text" name="domain_register" value="{{$domains->domain_register}}" class="form-control">
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-sm-9">
                         <input type="text" name="domain_price" value="{{$domains->domain_price}}" class="form-control">
                     </div>
                 </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-sm-9">
                         <input type="text" name="dead_time" id="J-xl"  value="{{$domains->dead_time}}" class="form-control">
                     </div>
                 </div>
                 <div class="form-group">
                     <label for="" class="col-sm-3">域名备注</label>
                     <div class="col-sm-9">
                         <input type="text" name="team_content" value="{{$domains->team_content}}" class="form-control">
                     </div>
                 </div>
                 <div class="form-group">
